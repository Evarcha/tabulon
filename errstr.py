...
CANT_HIDE_ROOT_NODE = 'Cannot hide the root node!'
CANT_REMOVE_ROOT_NODE = 'Cannot remove the root node!'
NO_CLIPBOARD = 'Clipboard functionality is not available right now. Install the pyperclip module to enable it.'
